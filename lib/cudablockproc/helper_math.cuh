...
inline __host__ __device__ bool operator==(const dim3& a, const dim3& b)
{
    return a.x == b.x && a.y == b.y && a.z == b.z;
}
...
inline __host__ __device__ bool operator<(const int3& a, const int b)
{
...
inline __host__ __device__ bool operator<(const dim3& a, const size_t b)
{
    return a.x < b && a.y < b && a.z < b;
}
...
inline __host__ __device__ dim3 operator+(dim3 a, dim3 b)
{
    return dim3(a.x + b.x, a.y + b.y, a.z + b.z);
}
inline __host__ __device__ void operator+=(dim3 &a, dim3 b)
{
    a.x += b.x;
    a.y += b.y;
    a.z += b.z;
}
inline __host__ __device__ dim3 operator+(dim3 a, size_t b)
{
    return dim3(a.x + b, a.y + b, a.z + b);
}
inline __host__ __device__ dim3 operator+(size_t b, dim3 a)
{
    return dim3(a.x + b, a.y + b, a.z + b);
}
inline __host__ __device__ void operator+=(dim3 &a, size_t b)
{
    a.x += b;
    a.y += b;
    a.z += b;
...
inline __host__ __device__ dim3 min(dim3 a, dim3 b)
{
    return dim3(min(a.x,b.x), min(a.y,b.y), min(a.z,b.z));
}
...
inline __host__ __device__ dim3 max(dim3 a, dim3 b)
{
    return dim3(max(a.x,b.x), max(a.y,b.y), max(a.z,b.z));
}
